(function(window) {
  ...
  var WebpointerIcons = {
    ...
    bringToFront: '<svg viewBox="0 0 24 24"><rect x="11" y="11" width="10" height="10" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/><rect x="7" y="7" width="10" height="10" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/><rect x="3" y="3" width="10" height="10" fill="#f59e0b" stroke="#d97706" stroke-width="1.5" rx="1"/></svg>',
    bringForward: '<svg viewBox="0 0 24 24"><rect x="9" y="9" width="12" height="12" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/><rect x="3" y="3" width="12" height="12" fill="#f59e0b" stroke="#d97706" stroke-width="1.5" rx="1"/></svg>',
    sendBackward: '<svg viewBox="0 0 24 24"><rect x="9" y="9" width="12" height="12" fill="#f59e0b" stroke="#d97706" stroke-width="1.5" rx="1"/><rect x="3" y="3" width="12" height="12" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/></svg>',
    sendToBack: '<svg viewBox="0 0 24 24"><rect x="11" y="11" width="10" height="10" fill="#f59e0b" stroke="#d97706" stroke-width="1.5" rx="1"/><rect x="7" y="7" width="10" height="10" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/><rect x="3" y="3" width="10" height="10" fill="#0f172a" stroke="currentColor" stroke-width="1.5" rx="1"/></svg>',
