...
var HELP_CONTENT_HTML = 
  ...
  '  <div class="question">' +
  '    <span class="q-badge">Q</span>' +
  '    <span>왜 누적 상금이 항상 누적 기댓값보다 작을까요?</span>' +
  '  </div>' +
  '  <div class="answer">' +
  '    <span class="a-badge">A</span>' +
  '    <span>누적 기댓값은 미실현 1등, 2등 값을 포함하기 때문입니다. 대부분의 참가자는 매주 100장씩 100년동안 구매해도 1등 당첨 확률이 6.19%밖에 되지 않습니다. 하지만 로또 1게임당 기댓값 약 500원 중, 무려 60%가 1등과 2등에서 기인합니다(1등:약245원, 2등: 약 37원, 3-5등합: 221원)</span>' +
  '  </div>' +
  '</div>' +
  '  <div class="help-card">' +
  '    <div class="question">' +
